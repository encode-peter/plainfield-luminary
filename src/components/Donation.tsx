...
export const Donation = () => {
  ...
  return (
    <section id="donate" className="py-24 px-4 bg-gradient-to-b from-card to-background relative overflow-hidden">
      {/* Glowing orbs */}
      ...
      <div className="container mx-auto relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto mb-8">
            Your donation helps us continue this beautiful tradition of bringing light, hope, and community 
            together. Every contribution makes a difference in keeping our streets glowing bright.
          </p>
        </div>
        ...
        <div className="max-w-2xl mx-auto">
          <Card className="p-8 md:p-12 bg-gradient-to-br from-primary/5 to-secondary/5 border-primary/20 text-center">
            ...
            <p className="text-muted-foreground mb-8">
              Join us in lighting up Plainfield this holiday season. Your generosity helps create 
              a magical experience for the entire community and supports local causes.
            </p>
